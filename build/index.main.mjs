  ...
  const _local = async (i, svs, args) => {
    ...
    if (stdlib.eq(i, stdlib.checkedBigNumberify('<builtin>', stdlib.UInt_max, '4'))) {
      ...
      return (await ((async (_v2469 ) => {
        ...
        const v2471 = stdlib.fromSome(v2470, stdlib.checkedBigNumberify('./index.rsh:239:46:decimal', stdlib.UInt_max, '0'));
        const v2472 = stdlib.protect(map1_ctc, await viewlib.viewMapRef(1, v2469), null);
        const v2473 = stdlib.fromSome(v2472, stdlib.checkedBigNumberify('./index.rsh:243:46:decimal', stdlib.UInt_max, '0'));
        const v2474 = stdlib.protect(map2_ctc, await viewlib.viewMapRef(2, v2469), null);
        const v2475 = stdlib.fromSome(v2474, stdlib.checkedBigNumberify('./index.rsh:246:60:decimal', stdlib.UInt_max, '0'));
        const v2476 = stdlib.protect(map3_ctc, await viewlib.viewMapRef(3, v2469), null);
        const v2477 = stdlib.fromSome(v2476, stdlib.checkedBigNumberify('./index.rsh:249:78:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0'));
        const v2478 = {
          lockTimestamp: v2475,
          reward: v2473,
...
export async function Creator(ctcTop, interact) {
  ...
  const v2372 = stdlib.safeMul(v2350, stdlib.checkedBigNumberify('./index.rsh:138:25:decimal', stdlib.UInt_max, '5'));
  const v2373 = stdlib.le(v2372, stdlib.checkedBigNumberify('./index.rsh:11:19:decimal', stdlib.UInt_max, '10000'));
  stdlib.assert(v2373, {
    at: 'reach standard library:57:5:application',
  ...
  const v2375 = stdlib.le(v2352, stdlib.checkedBigNumberify('./index.rsh:8:36:decimal', stdlib.UInt_max, '1000000000'));
  stdlib.assert(v2375, {
    at: 'reach standard library:57:5:application',
  ...
  const v2380 = stdlib.lt(v2379, stdlib.checkedBigNumberify('./index.rsh:7:38:decimal', stdlib.UInt_max, '10000000'));
  stdlib.assert(v2380, {
    at: 'reach standard library:57:5:application',
  ...
  const v2382 = stdlib.lt(v2353, stdlib.checkedBigNumberify('./index.rsh:7:38:decimal', stdlib.UInt_max, '10000000'));
  stdlib.assert(v2382, {
    at: 'reach standard library:57:5:application',
  ...
  const v2387 = stdlib.gt(v2357, stdlib.checkedBigNumberify('./index.rsh:155:31:decimal', stdlib.UInt_max, '0'));
  stdlib.assert(v2387, {
    at: 'reach standard library:57:5:application',
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    sim_p: (async (txn1) => {
      ...
      const v2404 = v2341[stdlib.checkedBigNumberify('./index.rsh:199:11:dot', stdlib.UInt_max, '0')];
      const v2405 = stdlib.Array_set(v2404, '0', stdlib.checkedBigNumberify('./index.rsh:199:11:dot', stdlib.UInt_max, '0'));
      const v2406 = stdlib.Array_set(v2341, stdlib.checkedBigNumberify('./index.rsh:199:11:dot', stdlib.UInt_max, '0'), v2405);
      const v2408 = v2406[stdlib.checkedBigNumberify('./index.rsh:199:11:dot', stdlib.UInt_max, '1')];
      const v2409 = stdlib.Array_set(v2408, '0', stdlib.checkedBigNumberify('./index.rsh:199:11:dot', stdlib.UInt_max, '0'));
      const v2410 = stdlib.Array_set(v2406, stdlib.checkedBigNumberify('./index.rsh:199:11:dot', stdlib.UInt_max, '1'), v2409);
      sim_r.txns.push({
      ...
      const v2438 = stdlib.safeMul256(v2437, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
      ...
      const v2443 = stdlib.safeDiv(v2442, stdlib.checkedBigNumberify('./index.rsh:11:19:decimal', stdlib.UInt_max, '10000'));
      const v2444 = stdlib.safeMul(v2400, v2393);
      const v2445 = stdlib.safeDiv(v2444, stdlib.checkedBigNumberify('./index.rsh:11:19:decimal', stdlib.UInt_max, '10000'));
      sim_r.isHalt = false;
  ...
  stdlib.assert(v2416, {
    at: 'reach standard library:57:5:application',
    fs: ['at ./index.rsh:133:10:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:212:16:application call to "initialChecks" (defined at: ./index.rsh:132:5:function exp)'],
    msg: 'Reach requires all tokens to be different. Consider using distribution contract instead.',
    who: 'Creator'
    });
  const v2418 = stdlib.safeMul(v2393, stdlib.checkedBigNumberify('./index.rsh:138:25:decimal', stdlib.UInt_max, '5'));
  const v2419 = stdlib.le(v2418, stdlib.checkedBigNumberify('./index.rsh:11:19:decimal', stdlib.UInt_max, '10000'));
  stdlib.assert(v2419, {
    at: 'reach standard library:57:5:application',
  ...
  const v2421 = stdlib.le(v2394, stdlib.checkedBigNumberify('./index.rsh:8:36:decimal', stdlib.UInt_max, '1000000000'));
  stdlib.assert(v2421, {
    at: 'reach standard library:57:5:application',
  ...
  const v2425 = stdlib.safeSub(v2398, v2397);
  const v2426 = stdlib.lt(v2425, stdlib.checkedBigNumberify('./index.rsh:7:38:decimal', stdlib.UInt_max, '10000000'));
  stdlib.assert(v2426, {
    at: 'reach standard library:57:5:application',
  ...
  const v2428 = stdlib.lt(v2401, stdlib.checkedBigNumberify('./index.rsh:7:38:decimal', stdlib.UInt_max, '10000000'));
  stdlib.assert(v2428, {
    at: 'reach standard library:57:5:application',
  ...
  const v2433 = stdlib.gt(v2399, stdlib.checkedBigNumberify('./index.rsh:155:31:decimal', stdlib.UInt_max, '0'));
  stdlib.assert(v2433, {
    at: 'reach standard library:57:5:application',
  ...
  const txn2 = await (ctc.sendrecv({
    ...
    sim_p: (async (txn2) => {
      ...
      const v2457 = v2410[stdlib.checkedBigNumberify('./index.rsh:232:11:dot', stdlib.UInt_max, '1')];
      const v2458 = v2457[stdlib.checkedBigNumberify('./index.rsh:232:11:dot', stdlib.UInt_max, '0')];
      const v2459 = stdlib.add(v2458, v2454);
      const v2461 = stdlib.Array_set(v2457, '0', v2459);
      const v2462 = stdlib.Array_set(v2410, stdlib.checkedBigNumberify('./index.rsh:232:11:dot', stdlib.UInt_max, '1'), v2461);
      sim_r.txns.push({
        amt: v2454,
        kind: 'to',
        tok: v2396
      ...
      const v2482 = v2397;
      const v2483 = v2397;
      const v2484 = stdlib.checkedBigNumberify('./index.rsh:302:15:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0');
      const v2485 = stdlib.checkedBigNumberify('./index.rsh:300:15:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0');
      const v2486 = v2443;
      const v2487 = stdlib.checkedBigNumberify('./index.rsh:298:7:decimal', stdlib.UInt_max, '0');
      const v2488 = v2450;
      const v2494 = v2462;
      const v2495 = v2453;
      ...
      if (await (async () => {
        ...
        return true;})()) {
        const v2537 = v2494[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
        const v2538 = v2537[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
        sim_r.isHalt = false;
        }
      else {
        sim_r.txns.push({
  ...
  let v2482 = v2397;
  let v2483 = v2397;
  let v2484 = stdlib.checkedBigNumberify('./index.rsh:302:15:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0');
  let v2485 = stdlib.checkedBigNumberify('./index.rsh:300:15:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0');
  let v2486 = v2443;
  let v2487 = stdlib.checkedBigNumberify('./index.rsh:298:7:decimal', stdlib.UInt_max, '0');
  let v2488 = v2450;
  let v2494 = v2462;
  let v2495 = v2453;
  ...
  let txn3 = txn2;
  while (await (async () => {
    const v2532 = v2494[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
    const v2533 = v2532[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
    const v2534 = stdlib.le(v2486, v2533);
    stdlib.assert(v2534, {
      at: './index.rsh:307:16:application',
      fs: ['at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
      msg: null,
      who: 'Creator'
      });
    const v2536 = stdlib.le(v2481, v2495);
    stdlib.assert(v2536, {
      at: './index.rsh:308:16:application',
      fs: ['at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
      msg: null,
      who: 'Creator'
      });
    ...
    switch (v2716[0]) {
      case 'claim0_477': {
        ...
        ;
        let v2818;
        const v2819 = stdlib.gt(v2487, stdlib.checkedBigNumberify('./index.rsh:342:29:decimal', stdlib.UInt_max, '0'));
        if (v2819) {
        ...
        const v2832 = stdlib.fromSome(v2831, stdlib.checkedBigNumberify('./index.rsh:239:46:decimal', stdlib.UInt_max, '0'));
        ...
        const v2835 = stdlib.fromSome(v2834, stdlib.checkedBigNumberify('./index.rsh:249:78:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0'));
        const v2836 = stdlib.safeSub256(v2818, v2835);
        const v2837 = stdlib.safeMul256(v2833, v2836);
        const v2838 = stdlib.safeDiv256(v2837, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
        ...
        const v2841 = stdlib.fromSome(v2840, stdlib.checkedBigNumberify('./index.rsh:243:46:decimal', stdlib.UInt_max, '0'));
        ...
        if (v2846) {
          ...
          const v2849 = stdlib.fromSome(v2848, stdlib.checkedBigNumberify('./index.rsh:246:60:decimal', stdlib.UInt_max, '0'));
        ...
        if (v2847) {
          ...
          await stdlib.mapSet(map1, v2715, stdlib.checkedBigNumberify('./index.rsh:287:18:decimal', stdlib.UInt_max, '0'));
          ...
          stdlib.assert(v2860, {
            ...
            fs: ['at ./index.rsh:468:68:application call to "claimRewards" (defined at: ./index.rsh:283:28:function exp)', 'at ./index.rsh:463:22:application call to [unknown function] (defined at: ./index.rsh:463:22:function exp)'],
            msg: null,
            who: 'Creator'
            });
          ...
          const v2873 = stdlib.Array_set(v2494, stdlib.checkedBigNumberify('./index.rsh:291:65:application', stdlib.UInt_max, '1'), v2872);
          ;
      ...
      case 'claimFees0_477': {
        ...
        stdlib.assert(v3230, {
          at: 'reach standard library:57:5:application',
          fs: ['at ./index.rsh:490:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:489:31:application call to [unknown function] (defined at: ./index.rsh:489:31:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:489:31:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)', 'at ./index.rsh:399:16:application call to [unknown function] (defined at: ./index.rsh:399:16:function exp)'],
        ...
        const v3430 = stdlib.eq(v2487, stdlib.checkedBigNumberify('./index.rsh:333:31:decimal', stdlib.UInt_max, '0'));
        ...
        if (v3432) {
          ...
          v3424 = stdlib.checkedBigNumberify('./index.rsh:337:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0');
          }
        const v3436 = stdlib.safeAdd256(v2484, v3424);
        const v3437 = stdlib.safeDiv256(v3436, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
        ...
        const v3461 = stdlib.Array_set(v2494, stdlib.checkedBigNumberify('./index.rsh:503:68:application', stdlib.UInt_max, '1'), v3460);
        ;
        ...
        const v3482 = stdlib.safeMul256(v3481, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
        const v3483 = stdlib.safeSub256(v3436, v3482);
        const cv2481 = stdlib.checkedBigNumberify('./index.rsh:512:15:decimal', stdlib.UInt_max, '0');
        const cv2482 = v2482;
        const cv2483 = v3427;
        const cv2484 = v3483;
        const cv2485 = v2485;
        const cv2486 = stdlib.checkedBigNumberify('./index.rsh:511:15:decimal', stdlib.UInt_max, '0');
        const cv2487 = v2487;
        const cv2488 = v2717;
        const cv2494 = v3461;
        const cv2495 = v3452;
      ...
      case 'stake0_477': {
        const v3711 = v2716[1];
        undefined /* setApiDetails */;
        const v3738 = v3711[stdlib.checkedBigNumberify('./index.rsh:400:12:spread', stdlib.UInt_max, '0')];
        const v3739 = stdlib.safeAdd(v2487, v3738);
        const v3740 = stdlib.lt(v3739, stdlib.UInt_max);
        stdlib.assert(v3740, {
          at: 'reach standard library:57:5:application',
          fs: ['at ./index.rsh:401:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:400:34:application call to [unknown function] (defined at: ./index.rsh:400:34:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:400:34:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)', 'at ./index.rsh:399:16:application call to [unknown function] (defined at: ./index.rsh:399:16:function exp)'],
          msg: 'maximum stakes has been reached',
          who: 'Creator'
          });
        ;
        const v3797 = v2494[stdlib.checkedBigNumberify('./index.rsh:297:19:dot', stdlib.UInt_max, '0')];
        const v3798 = v3797[stdlib.checkedBigNumberify('./index.rsh:297:19:dot', stdlib.UInt_max, '0')];
        const v3799 = stdlib.add(v3798, v3738);
        const v3801 = stdlib.Array_set(v3797, '0', v3799);
        const v3802 = stdlib.Array_set(v2494, stdlib.checkedBigNumberify('./index.rsh:297:19:dot', stdlib.UInt_max, '0'), v3801);
        ;
        ;
        let v3987;
        const v3988 = stdlib.gt(v2487, stdlib.checkedBigNumberify('./index.rsh:342:29:decimal', stdlib.UInt_max, '0'));
        if (v3988) {
        ...
        const v4001 = stdlib.fromSome(v4000, stdlib.checkedBigNumberify('./index.rsh:239:46:decimal', stdlib.UInt_max, '0'));
        ...
        const v4004 = stdlib.fromSome(v4003, stdlib.checkedBigNumberify('./index.rsh:249:78:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0'));
        const v4005 = stdlib.safeSub256(v3987, v4004);
        const v4006 = stdlib.safeMul256(v4002, v4005);
        const v4007 = stdlib.safeDiv256(v4006, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
        ...
        const v4010 = stdlib.fromSome(v4009, stdlib.checkedBigNumberify('./index.rsh:243:46:decimal', stdlib.UInt_max, '0'));
        ...
        let v4040;
        const v4046 = stdlib.eq(v2487, stdlib.checkedBigNumberify('./index.rsh:333:31:decimal', stdlib.UInt_max, '0'));
        ...
        if (v4048) {
          ...
          v4040 = stdlib.checkedBigNumberify('./index.rsh:337:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0');
          }
      ...
      case 'unstake0_477': {
        const v4207 = v2716[1];
        undefined /* setApiDetails */;
        const v4248 = v4207[stdlib.checkedBigNumberify('./index.rsh:424:12:spread', stdlib.UInt_max, '0')];
        const v4249 = stdlib.protect(map0_ctc, await stdlib.mapRef(map0, v2715), null);
        const v4250 = stdlib.fromSome(v4249, stdlib.checkedBigNumberify('./index.rsh:239:46:decimal', stdlib.UInt_max, '0'));
        const v4251 = v2494[stdlib.checkedBigNumberify('./index.rsh:425:38:application', stdlib.UInt_max, '0')];
        const v4252 = v4251[stdlib.checkedBigNumberify('./index.rsh:425:38:application', stdlib.UInt_max, '0')];
        const v4253 = stdlib.le(v4250, v4252);
        stdlib.assert(v4253, {
          at: 'reach standard library:57:5:application',
          fs: ['at ./index.rsh:425:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:424:38:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)', 'at ./index.rsh:399:16:application call to [unknown function] (defined at: ./index.rsh:399:16:function exp)'],
          msg: null,
          who: 'Creator'
          });
        ...
        stdlib.assert(v4255, {
          at: 'reach standard library:57:5:application',
          fs: ['at ./index.rsh:426:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:424:38:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)', 'at ./index.rsh:399:16:application call to [unknown function] (defined at: ./index.rsh:399:16:function exp)'],
        ...
        stdlib.assert(v4259, {
          at: 'reach standard library:57:5:application',
          fs: ['at ./index.rsh:427:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:424:38:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)', 'at ./index.rsh:399:16:application call to [unknown function] (defined at: ./index.rsh:399:16:function exp)'],
        ...
        ;
        let v4565;
        const v4566 = stdlib.gt(v2487, stdlib.checkedBigNumberify('./index.rsh:342:29:decimal', stdlib.UInt_max, '0'));
        if (v4566) {
        ...
        const v4582 = stdlib.fromSome(v4581, stdlib.checkedBigNumberify('./index.rsh:249:78:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '0'));
        const v4583 = stdlib.safeSub256(v4565, v4582);
        const v4584 = stdlib.safeMul256(v4580, v4583);
        const v4585 = stdlib.safeDiv256(v4584, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
        ...
        const v4588 = stdlib.fromSome(v4587, stdlib.checkedBigNumberify('./index.rsh:243:46:decimal', stdlib.UInt_max, '0'));
        ...
        if (v4593) {
          ...
          const v4596 = stdlib.fromSome(v4595, stdlib.checkedBigNumberify('./index.rsh:246:60:decimal', stdlib.UInt_max, '0'));
          const v4597 = stdlib.safeAdd(v4596, v2401);
          const v4598 = stdlib.le(v4597, v4592);
          v4594 = v4598;
          }
        const v4601 = v4594 ? stdlib.checkedBigNumberify('./index.rsh:433:51:decimal', stdlib.UInt_max, '0') : v4589;
        ...
        if (v4593) {
          ...
          const v4609 = stdlib.fromSome(v4608, stdlib.checkedBigNumberify('./index.rsh:246:60:decimal', stdlib.UInt_max, '0'));
        ...
        if (v4607) {
          ...
          const v4669 = stdlib.Array_set(v2494, stdlib.checkedBigNumberify('./index.rsh:443:51:application', stdlib.UInt_max, '0'), v4668);
          ;
          ...
          const v4695 = stdlib.gt(v4670, stdlib.checkedBigNumberify('./index.rsh:452:32:decimal', stdlib.UInt_max, '0'));
          ...
          await stdlib.mapSet(map1, v2715, stdlib.checkedBigNumberify('./index.rsh:438:31:decimal', stdlib.UInt_max, '0'));
          ...
          const v4624 = stdlib.Array_set(v2494, stdlib.checkedBigNumberify('./index.rsh:443:51:application', stdlib.UInt_max, '0'), v4623);
          ;
          ...
          const v4650 = stdlib.gt(v4625, stdlib.checkedBigNumberify('./index.rsh:452:32:decimal', stdlib.UInt_max, '0'));
  ...
  const v4703 = v2494[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
  const v4704 = v4703[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
...
export async function _claim4(ctcTop, interact) {
  ...
  const v2584 = stdlib.protect(ctc10, await interact.in(), {
    ...
    fs: ['at ./index.rsh:460:27:application call to [unknown function] (defined at: ./index.rsh:460:27:function exp)', 'at ./index.rsh:297:19:application call to "runclaim0_477" (defined at: ./index.rsh:460:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: 'in',
    who: 'claim'
    });
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    onlyIf: true,
    out_tys: [ctc12],
    pay: [stdlib.checkedBigNumberify('./index.rsh:462:12:decimal', stdlib.UInt_max, '0'), [[stdlib.checkedBigNumberify('./index.rsh:462:16:decimal', stdlib.UInt_max, '0'), v2395], [stdlib.checkedBigNumberify('./index.rsh:462:33:decimal', stdlib.UInt_max, '0'), v2396]]],
    sim_p: (async (txn1) => {
      const sim_r = { txns: [], mapRefs: [], maps: [] };
      let sim_txn_ctr = stdlib.UInt_max;
      const getSimTokCtr = () => { sim_txn_ctr = sim_txn_ctr.sub(1); return sim_txn_ctr; };
      ...
      switch (v2716[0]) {
        case 'claim0_477': {
          ...
          if (v2847) {
            const v2854 = stdlib.safeMuldiv(v2842, v2400, v2399);
            await stdlib.simMapSet(sim_r, 1, v2715, stdlib.checkedBigNumberify('./index.rsh:287:18:decimal', stdlib.UInt_max, '0'));
            const v2864 = stdlib.sub(v2495, v2854);
            sim_r.txns.push({
              kind: 'from',
              to: v2715,
      ...
      if (v2847) {
        ...
        if (v1687) {
          stdlib.protect(ctc0, await interact.out(v2719, v2888), {
            ...
            fs: ['at ./index.rsh:460:13:application call to [unknown function] (defined at: ./index.rsh:460:13:function exp)', 'at ./index.rsh:470:23:application call to "callback" (defined at: ./index.rsh:463:22:function exp)', 'at ./index.rsh:463:22:application call to [unknown function] (defined at: ./index.rsh:463:22:function exp)'],
            msg: 'out',
            who: 'claim'
            });
          }
        ...
        const v8521 = v2873;
        const v8522 = v2864;
        const v8523 = v2873[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
        const v8524 = v8523[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
        ...
        if (v1687) {
          stdlib.protect(ctc0, await interact.out(v2719, v2910), {
            at: './index.rsh:460:13:application',
            fs: ['at ./index.rsh:460:13:application call to [unknown function] (defined at: ./index.rsh:460:13:function exp)', 'at ./index.rsh:474:23:application call to "callback" (defined at: ./index.rsh:463:22:function exp)', 'at ./index.rsh:463:22:application call to [unknown function] (defined at: ./index.rsh:463:22:function exp)'],
            msg: 'out',
            who: 'claim'
            });
          }
        ...
        const v8543 = v2494;
        const v8544 = v2495;
        const v8545 = v2494[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
        const v8546 = v8545[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
...
export async function _claimFees4(ctcTop, interact) {
  ...
  const v2592 = stdlib.protect(ctc10, await interact.in(), {
    at: './index.rsh:1:23:application',
    fs: ['at ./index.rsh:489:31:application call to [unknown function] (defined at: ./index.rsh:489:31:function exp)', 'at ./index.rsh:297:19:application call to "runclaimFees0_477" (defined at: ./index.rsh:489:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: 'in',
    who: 'claimFees'
    });
  ...
  stdlib.assert(v2593, {
    at: 'reach standard library:57:5:application',
    fs: ['at ./index.rsh:490:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:489:31:application call to [unknown function] (defined at: ./index.rsh:489:31:function exp)', 'at ./index.rsh:297:19:application call to "runclaimFees0_477" (defined at: ./index.rsh:489:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: 'only beneficiary can claim creation fees',
    who: 'claimFees'
    });
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    onlyIf: true,
    out_tys: [ctc12],
    pay: [stdlib.checkedBigNumberify('./index.rsh:493:12:decimal', stdlib.UInt_max, '0'), [[stdlib.checkedBigNumberify('./index.rsh:493:16:decimal', stdlib.UInt_max, '0'), v2395], [stdlib.checkedBigNumberify('./index.rsh:493:33:decimal', stdlib.UInt_max, '0'), v2396]]],
    sim_p: (async (txn1) => {
      const sim_r = { txns: [], mapRefs: [], maps: [] };
      let sim_txn_ctr = stdlib.UInt_max;
      const getSimTokCtr = () => { sim_txn_ctr = sim_txn_ctr.sub(1); return sim_txn_ctr; };
      ...
      switch (v2716[0]) {
        ...
        case 'claimFees0_477': {
          ...
          const v3482 = stdlib.safeMul256(v3481, stdlib.checkedBigNumberify('./index.rsh:5:28:decimal', '115792089237316195423570985008687907853269984665640564039457584007913129639935', '1000000000000000000'));
          const v3483 = stdlib.safeSub256(v3436, v3482);
          const v8689 = stdlib.checkedBigNumberify('./index.rsh:512:15:decimal', stdlib.UInt_max, '0');
          const v8690 = v2482;
          const v8691 = v3427;
          const v8692 = v3483;
          const v8693 = v2485;
          const v8694 = stdlib.checkedBigNumberify('./index.rsh:511:15:decimal', stdlib.UInt_max, '0');
          const v8695 = v2487;
          const v8697 = v3461;
          const v8698 = v3452;
          sim_r.isHalt = false;
    ...
    case 'claimFees0_477': {
      ...
      if (v1687) {
        stdlib.protect(ctc0, await interact.out(v3215, v3469), {
          at: './index.rsh:489:13:application',
          fs: ['at ./index.rsh:489:13:application call to [unknown function] (defined at: ./index.rsh:489:13:function exp)', 'at ./index.rsh:504:21:application call to "callback" (defined at: ./index.rsh:494:22:function exp)', 'at ./index.rsh:494:22:application call to [unknown function] (defined at: ./index.rsh:494:22:function exp)'],
          msg: 'out',
          who: 'claimFees'
          });
        }
      ...
      const v8697 = v3461;
      const v8698 = v3452;
      const v8699 = v3461[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
      const v8700 = v8699[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
      const v8701 = stdlib.le(stdlib.checkedBigNumberify('./index.rsh:511:15:decimal', stdlib.UInt_max, '0'), v8700);
      stdlib.assert(v8701, {
        at: './index.rsh:307:16:application',
        fs: ['at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
        msg: null,
      ...
      const v8702 = stdlib.le(stdlib.checkedBigNumberify('./index.rsh:512:15:decimal', stdlib.UInt_max, '0'), v3452);
      stdlib.assert(v8702, {
        at: './index.rsh:308:16:application',
        fs: ['at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
        msg: null,
...
export async function _stake4(ctcTop, interact) {
  ...
  const v2545 = stdlib.protect(ctc10, await interact.in(), {
    at: './index.rsh:1:23:application',
    fs: ['at ./index.rsh:400:34:application call to [unknown function] (defined at: ./index.rsh:400:34:function exp)', 'at ./index.rsh:297:19:application call to "runstake0_477" (defined at: ./index.rsh:400:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: 'in',
    who: 'stake'
    });
  const v2546 = v2545[stdlib.checkedBigNumberify('./index.rsh:1:23:application', stdlib.UInt_max, '0')];
  const v2548 = stdlib.safeAdd(v2487, v2546);
  const v2549 = stdlib.lt(v2548, stdlib.UInt_max);
  stdlib.assert(v2549, {
    at: 'reach standard library:57:5:application',
    fs: ['at ./index.rsh:401:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:400:34:application call to [unknown function] (defined at: ./index.rsh:400:34:function exp)', 'at ./index.rsh:297:19:application call to "runstake0_477" (defined at: ./index.rsh:400:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: 'maximum stakes has been reached',
    who: 'stake'
    });
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    onlyIf: true,
    out_tys: [ctc12],
    pay: [stdlib.checkedBigNumberify('./index.rsh:404:12:decimal', stdlib.UInt_max, '0'), [[v2546, v2395], [stdlib.checkedBigNumberify('./index.rsh:404:39:decimal', stdlib.UInt_max, '0'), v2396]]],
    sim_p: (async (txn1) => {
      const sim_r = { txns: [], mapRefs: [], maps: [] };
      let sim_txn_ctr = stdlib.UInt_max;
      const getSimTokCtr = () => { sim_txn_ctr = sim_txn_ctr.sub(1); return sim_txn_ctr; };
    ...
    case 'stake0_477': {
      ...
      if (v1687) {
        stdlib.protect(ctc0, await interact.out(v3711, v4026), {
          at: './index.rsh:400:13:application',
          fs: ['at ./index.rsh:400:13:application call to [unknown function] (defined at: ./index.rsh:400:13:function exp)', 'at ./index.rsh:411:21:application call to "callback" (defined at: ./index.rsh:405:22:function exp)', 'at ./index.rsh:405:22:application call to [unknown function] (defined at: ./index.rsh:405:22:function exp)'],
          msg: 'out',
          who: 'stake'
          });
        }
      ...
      const v8851 = v3802;
      const v8852 = v2495;
      const v8853 = v3802[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
      const v8854 = v8853[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
...
export async function _unstake4(ctcTop, interact) {
  ...
  const v2560 = stdlib.protect(ctc10, await interact.in(), {
    at: './index.rsh:1:23:application',
    fs: ['at ./index.rsh:424:38:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to "rununstake0_477" (defined at: ./index.rsh:424:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: 'in',
    who: 'unstake'
    });
  const v2561 = v2560[stdlib.checkedBigNumberify('./index.rsh:1:23:application', stdlib.UInt_max, '0')];
  const v2563 = stdlib.protect(map0_ctc, await stdlib.mapRef(map0, v2558), null);
  const v2564 = stdlib.fromSome(v2563, stdlib.checkedBigNumberify('./index.rsh:239:46:decimal', stdlib.UInt_max, '0'));
  const v2565 = v2494[stdlib.checkedBigNumberify('./index.rsh:425:38:application', stdlib.UInt_max, '0')];
  const v2566 = v2565[stdlib.checkedBigNumberify('./index.rsh:425:38:application', stdlib.UInt_max, '0')];
  const v2567 = stdlib.le(v2564, v2566);
  stdlib.assert(v2567, {
    at: 'reach standard library:57:5:application',
    fs: ['at ./index.rsh:425:14:application call to "check" (defined at: reach standard library:49:32:function exp)', 'at ./index.rsh:424:38:application call to [unknown function] (defined at: ./index.rsh:424:38:function exp)', 'at ./index.rsh:297:19:application call to "rununstake0_477" (defined at: ./index.rsh:424:12:function exp)', 'at ./index.rsh:297:19:application call to [unknown function] (defined at: ./index.rsh:297:19:function exp)'],
    msg: null,
    who: 'unstake'
    });
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    onlyIf: true,
    out_tys: [ctc12],
    pay: [stdlib.checkedBigNumberify('./index.rsh:430:12:decimal', stdlib.UInt_max, '0'), [[stdlib.checkedBigNumberify('./index.rsh:430:16:decimal', stdlib.UInt_max, '0'), v2395], [stdlib.checkedBigNumberify('./index.rsh:430:33:decimal', stdlib.UInt_max, '0'), v2396]]],
    sim_p: (async (txn1) => {
      const sim_r = { txns: [], mapRefs: [], maps: [] };
      let sim_txn_ctr = stdlib.UInt_max;
      const getSimTokCtr = () => { sim_txn_ctr = sim_txn_ctr.sub(1); return sim_txn_ctr; };
      ...
      switch (v2716[0]) {
        ...
        case 'unstake0_477': {
          ...
          if (v4607) {
            ...
            await stdlib.simMapSet(sim_r, 1, v2715, stdlib.checkedBigNumberify('./index.rsh:438:31:decimal', stdlib.UInt_max, '0'));
            const v4615 = stdlib.safeSub(v4250, v4248);
      ...
      if (v4607) {
        ...
        if (v1687) {
          stdlib.protect(ctc0, await interact.out(v4207, v4682), {
            at: './index.rsh:424:13:application',
            fs: ['at ./index.rsh:424:13:application call to [unknown function] (defined at: ./index.rsh:424:13:function exp)', 'at ./index.rsh:447:21:application call to "callback" (defined at: ./index.rsh:431:22:function exp)', 'at ./index.rsh:431:22:application call to [unknown function] (defined at: ./index.rsh:431:22:function exp)'],
            msg: 'out',
            who: 'unstake'
            });
          }
        ...
        const v9005 = v4669;
        const v9006 = v2495;
        const v9007 = v4669[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
        const v9008 = v9007[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
        ...
        const v9027 = v4624;
        const v9028 = v2495;
        const v9029 = v4624[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '1')];
        const v9030 = v9029[stdlib.checkedBigNumberify('./index.rsh:307:43:application', stdlib.UInt_max, '0')];
...
export const _stateSourceMap = {
  ...
  3: {
    at: './index.rsh:518:11:after expr stmt semicolon',
    fs: [],
    msg: null,
    who: 'Module'
    },
  4: {
    at: './index.rsh:297:19:after expr stmt semicolon',
    fs: [],
    msg: null,
    who: 'Module'
    }
